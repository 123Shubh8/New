...
Original file is located at
    https://colab.research.google.com/drive/1JctjMUCdSE0E4KfGZnT2SMYggceHrNJ-
"""
...
def knn(X_train, X_test, y_train, y_test, neighbors, power):
    ...
    |-----------------|-------------------|--------------------|
    | Actual Positive | True Positive (TP) {cm[0, 0]} | False Negative (FN) {cm[0, 1]} |
    |-----------------|-------------------|--------------------|
    | Actual Negative | False Positive (FP) {cm[1, 0]} | True Negative (TN) {cm[1, 1]} |
    ''')
